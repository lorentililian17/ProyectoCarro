...
namespace ProyectoCarro.Class
{
    internal class Carro
    {
        ...
        public void apagarmotor()
        {
            if (Encendido == 1)
            {
                Console.WriteLine("Tu Carro esta siendo apagado");
                Console.WriteLine("Tu carro ya está apagado");
                Encendido = 0;
            }
            else
            {
                Console.WriteLine("Weii! el carro ya estaba apagado");
            }
        }
